    ...
    def on_render(self) -> None:
        ...
        for x in range(grid_x(self.mouse.flood)):
            for y in range(grid_y(self.mouse.flood)):
                ...
                self._display_surf.blit(img, ((x*CELL_SIZE*SCALE)+(CELL_SIZE*SCALE/2)-(img.get_width()/2), self._height-(y*CELL_SIZE*SCALE)-(CELL_SIZE*SCALE)+(CELL_SIZE*SCALE/2)-(img.get_height()/2)))
